...
import com.chalabi.EtudeDeCas.stubs.*;
...
public class ReservationServiceGrpcImpl extends ReservationServiceGrpc.ReservationServiceImplBase {
    ...
    public void createReservation(Reservation request, StreamObserver<Reservation> responseObserver) {
        ...
        try {
            ...
            com.chalabi.EtudeDeCas.entities.Reservation reservation = new com.chalabi.EtudeDeCas.entities.Reservation();
            reservation.setClient(client);
            reservation.setChambre(chambre);
            reservation.setDateDebut(dateDebut);
            reservation.setDateFin(dateFin);
            reservation.setPreferences(request.getPreferences());
            com.chalabi.EtudeDeCas.entities.Reservation savedReservation = reservationRepository.save(reservation);
            Reservation grpcReservation = Reservation.newBuilder()
                    .setId(savedReservation.getId())
                    .setClient(
                            com.chalabi.EtudeDeCas.stubs.Client.newBuilder()
                                    .setId(client.getId())
                    ...
                    .setChambre(
                            com.chalabi.EtudeDeCas.stubs.Chambre.newBuilder()
                                    .setId(chambre.getId())
    ...
    public void listReservations(Empty request, StreamObserver<ReservationList> responseObserver) {
        List<com.chalabi.EtudeDeCas.entities.Reservation> reservations = reservationRepository.findAll();
        ReservationList.Builder responseBuilder = ReservationList.newBuilder();
        for (com.chalabi.EtudeDeCas.entities.Reservation reservation : reservations) {
            Reservation grpcReservation = Reservation.newBuilder()
    ...
    public void getReservationById(GetReservationRequest request, StreamObserver<Reservation> responseObserver) {
        try {
            ...
            com.chalabi.EtudeDeCas.entities.Reservation reservationEntity =
    ...
    public void updateReservation(UpdateReservationRequest request, StreamObserver<Reservation> responseObserver) {
        try {
            ...
            com.chalabi.EtudeDeCas.entities.Reservation updatedReservation = reservationRepository.save(reservationEntity);
